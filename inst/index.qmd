...
👉 [ghcr.io/mx-jx/mybook](https://ghcr.io/mx-jx/mybook) 🐳
...
#| eval: false
docker run -it ghcr.io/mx-jx/mybook:devel R
```
...
#| eval: false
docker run -it ghcr.io/mx-jx/mybook:devel bash
